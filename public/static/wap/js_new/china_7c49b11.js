define("common:widget/echarts/china.js", function (e, o) {
    !function (t, s) {
        "function" == typeof define && define.amd ? define(["exports", "echarts"], s) : "object" == typeof o && "string" != typeof o.nodeName ? s(o, e("common:widget/echarts/echarts.js")) : s({}, t.echarts)
    }(this, function (e, o) {
        var t = function (e) {
            "undefined" != typeof console && console && console.error && void 0
        };
        return o ? o.registerMap ? void o.registerMap("china2", {
            ...
            UTF8Encoding: !0
        }) : void t("ECharts Map is not loaded") : void t("ECharts is not Loaded")
    })
});