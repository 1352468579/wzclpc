define("desktop:widget/wzcl-player/wzcl-player.js", function (e, i, t) {
    function n(e, i) {
        ...
        }), e.append(n.find(".wzcl-player-container").unwrap()).addClass("wzcl-player"), n = e, e = n.find(".player")), this._$container = n, this._media = new (c.supportVideo ? u : d)(e, i), this._ratio = m[i.ratio] || m["16:9"], this._waiting = !1, this._paused = !0, this._ready = !1, this._load = !1, this._fullscreen = !1, this._hideBarTimer = !1, this._darging = !1, this._error = !1;
        var s = n.find(".player-ui"), o = s.find(".control-bar"), v = o.find(".progress-bar .buffer"), w = o.find(".progress-bar .progress"), y = o.find(".time.duration"), S = o.find(".time.current-time");
