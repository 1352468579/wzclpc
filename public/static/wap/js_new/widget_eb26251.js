define("desktop:widget/nav-version5/nav-version5.js", function (e) {
    ...
    var h = [], f = [{id: 13, name: "语文", enname: "yuwen"}, {id: 14, name: "数学", enname: "shuxue"}, {
            id: 15,
            name: "英语",
            enname: "yingyu"
        }, {id: 16, name: "奥数", enname: "aoshu"}, {id: 17, name: "物理", enname: "wuli"}, {
            id: 18,
            name: "化学",
            enname: "huaxue"
        }, {id: 19, name: "生物", enname: "shengwu"}, {id: 20, name: "科学", enname: "kexue"}],
        d = [{id: 1, name: "一年级", enname: "xiaoyi"}, {id: 2, name: "二年级", enname: "xiaoer"}, {
            id: 3,
            name: "三年级",
            enname: "xiaosan"
        }, {id: 4, name: "四年级", enname: "xiaosi"}, {id: 5, name: "五年级", enname: "xiaowu"}, {
            id: 6,
            name: "六年级",
            enname: "xiaoliu"
        }], v = [{id: 7, name: "初一", enname: "chuyi"}, {id: 8, name: "初二", enname: "chuer"}, {
            id: 9,
            name: "初三",
            enname: "chusan"
        }], g = [{id: 10, name: "高一", enname: "gaoyi"}, {id: 11, name: "高二", enname: "gaoer"}, {
            id: 12,
            name: "高三",
            enname: "gaosan"
        }];
    if (m) {
        if (m["小学"]) {
            for (var p = [], T = 0; T < d.length; T++) n(m["小学"], p, d[T]);
            h.push({id: 110, name: "小学", enname: "xiaoxue", grade: p})
        }
        if (m["初中"]) {
            for (var w = [], T = 0; T < v.length; T++) n(m["初中"], w, v[T]);
            h.push({id: 120, name: "初中", enname: "chuzhong", grade: w})
        }
        if (m["高中"]) {
            for (var x = [], T = 0; T < g.length; T++) n(m["高中"], x, g[T]);
            h.push({id: 130, name: "高中", enname: "gaozhong", grade: x})
        }
    }
    !function () {
        ...
        function i(e, n, i, o) {
            e.append('<li><a href ="/wzcl-lessons/' + h[n].grade[i].enname + "-" + h[n].grade[i].phase[o].enname + '.html">' + h[n].grade[i].phase[o].name + "</a></li>")
        }

        var o, a, t, s, r = u("#n-nav-area"), c = u(".wzclLessons"), l = u(".secondwzclLessons"),
            m = u(".thirdwzclLessons"), f = u(".zixunTags"), d = u(".primary-courses");
...
;define("desktop:widget/quick-appoint-renew/quick-appoint-renew.js", function (e) {
    ...
    s.addRule("chineseAndWord", function (e) {
        ...
        t = o.string.trim(e.element.val()) || null, l.Api.post(l.data.get("api.userExists"), {mobile: t}).done(function (e) {
    ...
    !function () {
                ...
                element: n, autoSubmit: !1, onFormValidated: function (e) {
                    if (!y) {
                        ...
                        r.html("提交中...").prop("disabled", !0), y = !0, a.ajax({
                            url: "/api/student/register-and-book",
                            type: "POST",
                            dataType: "json",
                            data: d
                        }).success(function (e) {
        ...
        }), a("body").hasClass("lt-ie9") ? a("input[name=freeTime]")[0].readOnly = !1 : e.async("common:widget/picker/picker.js", function () {
...
;define("desktop:widget/footer-version-renew/footer-version-renew.js", function (e) {
    !function () {
        ...
        for (var t = e("common:widget/jquery/1.11.3/jquery.js"), n = [{
            hotLabels: {
                ...
                contents: [{
                    ...
                    labelName: "在线辅导",
                    labelHref: ""
                }, {id: "2", labelName: "在线辅导班", labelHref: ""}, {
                    id: "3",
                    labelName: "中小学教育网校",
                    labelHref: ""
                }, {id: "4", labelName: "补习机构", labelHref: ""}, {
                    id: "5",
                    labelName: "一对一辅导",
                    labelHref: ""
                }, {id: "6", labelName: "英语一对一家教", labelHref: ""}, {
                    id: "7",
                    labelName: "初中数学辅导",
                    labelHref: ""
                }, {id: "8", labelName: "化学辅导", labelHref: ""}, {
                    id: "9",
                    labelName: "作文辅导",
                    labelHref: ""
                }, {id: "10", labelName: "初中英语补习",
                    labelHref: ""}, {
                    id: "11",
                    labelName: "高中英语辅导",
                    labelHref: ""
                }, {id: "12", labelName: "高中生物补习",
                    labelHref: ""}, {
                    id: "13",
                    labelName: "八年级物理辅导",
                    labelHref: ""
        ...
        }], h = t(".linkmap1"), m = t(".linkmap2"), s = 0; s < n[0].hotLabels.contents.length; s++) h.append('<a class="im" href="' + n[0].hotLabels.contents[s].labelHref + '" target="_blank">' + n[0].hotLabels.contents[s].labelName + "</a>");
        for (var s = 0; s < n[0].hotLessons.contents.length; s++) m.append('<a class="im" href="' + n[0].hotLessons.contents[s].labelHref + '" target="_blank">' + n[0].hotLessons.contents[s].labelName + "</a>");
