!function () {
    ...
    var i = require("common:widget/zm/zm.js"), o = {}, r = null;
    ...
    o.Utils.sendMessage = function (e) {
        if (e) {
            var t = i.data.get("extras.zmTjUrl") + "/z.gif?", n = o.Utils.getUrl(),
                r = o.Utils.getQueryString("channel_code") || "", c = o.Utils.getQueryString("channel_keyword") || "",
                u = o.Utils.getTitle(), a = o.Utils.getPreUrl(), g = o.Utils.getRp(), f = o.Utils.getColorDepth(),
                d = e.ev || "", m = e.ck || "", U = e.li || "", h = e.lt || "", p = e.lo || "", v = e.sk || "",
                k = new Image(1, 1);
