define("desktop:widget/information-share-bar/information-share-bar.js", function (t) {
    var e = t("common:widget/jquery/1.11.3/jquery.js"), o = t("desktop:widget/information-share-bar/shareWidget.js"), i = t("common:widget/zm/zm.js");
    !function () {
        var t = e(".articleDetail").find("h3.title").text(), a = i.data.get("extras.picUrl"), s = i.data.get("extras.sectionName"), r = i.data.get("extras.summary").slice(0, 30);
        r = "望子成龙资讯【" + s + "】| " + t + "-望子成龙资讯 - ▍" + r + "（分享自@望子成龙官网）", e(".article-suspend-tool .share").hover(function () {
