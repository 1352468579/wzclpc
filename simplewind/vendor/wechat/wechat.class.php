...
class Wechat
{
    ...
    {
        return $this->http_post(self::API_URL_PREFIX.self::MENU_CREATE_URL.'access_token=11_Gf4wZ3b7M-0wY8fevUktGiuxFfDufAFuB1SyVcK-Smbgg5PKk6JoxIh575elk_1DYP2fu-27ww2u3BJx-0UjOVf_Qw1rTTUGj9WomDedgw5lC-CFjcEx-GA8UP0CEOcAJAWYI',self::json_encode($data));
    }
