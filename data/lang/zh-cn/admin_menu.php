<?php
return array (
  'ADMIN_ABOUT_APPEDITPOST' => '客户端下载编辑',
  'ADMIN_ABOUT_AREAADDPOST' => '学区分布添加',
  'ADMIN_ABOUT_AREADELETE' => '校区分布删除',
  'ADMIN_ABOUT_AREAEDITPOST' => '校区分布编辑',
  'ADMIN_ABOUT_DEFAULT' => '关于我们',
  'ADMIN_ABOUT_DOWNLOADAPP' => '客户端下载',
  'ADMIN_ABOUT_INDEX' => '学校介绍',
  'ADMIN_ABOUT_SCHOOLADDPOST' => '学校介绍添加',
  'ADMIN_ABOUT_SCHOOLDELETE' => '学校介绍删除',
  'ADMIN_ABOUT_SCHOOLEDITPOST' => '学校介绍',
  'ADMIN_ABOUT_SCHOOLLIST' => '校区分布管理',
  'ADMIN_ACTIVITY_FEEDBACK' => '反馈意见',
  'ADMIN_APPLY_ADDPOST' => '课程管理添加',
  'ADMIN_APPLY_APPLYRECORD' => '申请记录',
  'ADMIN_APPLY_DEFAULT' => '申请管理',
  'ADMIN_APPLY_DELETE' => '课程管理删除',
  'ADMIN_APPLY_EDITPOST' => '课程管理编辑',
  'ADMIN_APPLY_INDEX' => '课程管理',
  'ADMIN_APPLY_VACATION' => '活动申请',
  'ADMIN_ATTRIBUTES_ADDPOST' => '属性添加',
  'ADMIN_ATTRIBUTES_DELETE' => '属性删除',
  'ADMIN_ATTRIBUTES_EDITPOST' => '属性编辑',
  'ADMIN_ATTRIBUTES_INDEX' => '属性管理',
  'ADMIN_BANNER_ADDPOST' => 'banner添加',
  'ADMIN_BANNER_DELETE' => 'banner删除',
  'ADMIN_BANNER_EDITPOST' => 'banner编辑',
  'ADMIN_BANNER_INDEX' => '模块一(banner)',
  'ADMIN_CHILDREN_EDIT' => '儿童学员',
  'ADMIN_CLASSOPTION_ADDPOST' => '课程设置添加',
  'ADMIN_CLASSOPTION_DELETE' => '课程设置删除',
  'ADMIN_CLASSOPTION_EDITPOST' => '课程设置编辑',
  'ADMIN_CLASSOPTION_HOTCLASS' => '热门课程',
  'ADMIN_CLASSOPTION_INDEX' => '课程设置',
  'ADMIN_FILES_ADDPOST' => '文件管理添加',
  'ADMIN_FILES_ARTICLE' => '学案下载管理',
  'ADMIN_FILES_DEFAULT' => '学案下载',
  'ADMIN_FILES_DELETE' => '文件管理删除',
  'ADMIN_FILES_EDITPOST' => '文件管理编辑',
  'ADMIN_FILES_FILECATEGORY' => '文件分类管理',
  'ADMIN_FILES_FILECATEGORYADDPOST' => '文件分类管理添加',
  'ADMIN_FILES_FILECATEGORYDELETE' => '文件分类管理删除',
  'ADMIN_FILES_FILECATEGORYEDITPOST' => '文件分类管理编辑',
  'ADMIN_FILES_INDEX' => '文件管理',
  'ADMIN_HOOK_INDEX' => '钩子管理',
  'ADMIN_HOOK_PLUGINLISTORDER' => '钩子插件排序',
  'ADMIN_HOOK_PLUGINS' => '钩子插件管理',
  'ADMIN_HOOK_SYNC' => '同步钩子',
  'ADMIN_INDEXPC_ADDPOST' => '模块添加',
  'ADMIN_INDEXPC_DEFAULT' => '首页',
  'ADMIN_INDEXPC_DELETE' => '模块删除',
  'ADMIN_INDEXPC_EDITPOST' => '模块编辑',
  'ADMIN_INDEXPC_INDEX' => '其他模块',
  'ADMIN_INDEXPC_OBJECT' => '模块(专业课程体系)',
  'ADMIN_INDEXPC_OBJECTADDPOST' => '专业课程体系添加',
  'ADMIN_INDEXPC_OBJECTDELETE' => '专业模块删除',
  'ADMIN_INDEXPC_OBJECTEDITPOST' => '专业课程体系编辑',
  'ADMIN_INDEXPC_VIDEO' => '视频',
  'ADMIN_LINK_ADD' => '添加友情链接',
  'ADMIN_LINK_ADDPOST' => '添加友情链接提交保存',
  'ADMIN_LINK_DEFAULT' => '友情链接',
  'ADMIN_LINK_DELETE' => '删除友情链接',
  'ADMIN_LINK_EDIT' => '编辑友情链接',
  'ADMIN_LINK_EDITPOST' => '编辑友情链接提交保存',
  'ADMIN_LINK_INDEX' => '热门课程',
  'ADMIN_LINK_LISTORDER' => '友情链接排序',
  'ADMIN_LINK_TOGGLE' => '友情链接显示隐藏',
  'ADMIN_LIVE_ADDPOST' => '公开课添加',
  'ADMIN_LIVE_BANNEREDIT' => 'banner',
  'ADMIN_LIVE_BANNEREDITPOST' => 'bann编辑',
  'ADMIN_LIVE_DEFAULT' => '公开课',
  'ADMIN_LIVE_DELETE' => '公开课删除',
  'ADMIN_LIVE_EDITPOST' => '公开课编辑',
  'ADMIN_LIVE_INDEX' => '公开课',
  ...
  'ADMIN_NEWS_ADDPOST' => '新闻分类添加',
  'ADMIN_NEWS_ADVEDIT' => '广告图',
  'ADMIN_NEWS_ADVEDITPOST' => '广告图',
  'ADMIN_NEWS_BANNEREDIT' => 'banner',
  'ADMIN_NEWS_BANNEREDITPOST' => 'banner编辑',
  'ADMIN_NEWS_DEFAULT' => '新闻资讯',
  'ADMIN_NEWS_DELETE' => '新闻分类删除',
  'ADMIN_NEWS_EDITPOST' => '新闻分类编辑',
  'ADMIN_NEWS_FOOTER' => '优秀的1对1教育品牌',
  'ADMIN_NEWS_FOOTEREDITPOST' => '编辑',
  'ADMIN_NEWS_HOTCLASSRECODE' => '热门课程二维码',
  'ADMIN_NEWS_HOTCLASSRECODEEDITPOST' => '热门课程二维码编辑',
  'ADMIN_NEWS_INDEX' => '新闻分类管理',
  'ADMIN_NEWS_NEWADDPOST' => '新闻文章添加',
  'ADMIN_NEWS_NEWDELETE' => '新闻文章删除',
  'ADMIN_NEWS_NEWEDITPOST' => '新闻文章编辑',
  'ADMIN_NEWS_NEWSLIST' => '新闻文章管理',
  'ADMIN_NEWS_RECOMMENDBLOCK' => '推荐版块',
  'ADMIN_NEWS_RECOMMENDBLOCKEDITPOST' => '推荐版块编辑',
  ...
  'ADMIN_PRODUCTCATEGORY_INDEX' => '商品分类管理',
  ...
  'ADMIN_REPUTATION_ADDPOST' => '学员口碑添加',
  'ADMIN_REPUTATION_DELETE' => '学员口碑删除',
  'ADMIN_REPUTATION_EDITPOST' => '学员口碑编辑',
  'ADMIN_REPUTATION_INDEX' => 'PC端',
  'ADMIN_REPUTATION_INDEX2' => '学员口碑',
  'ADMIN_REPUTATIONWAP_INDEX' => 'WAP端',
  ...
  'ADMIN_SCHOOLADVANTAGE_ADDPOST' => '办学优势添加',
  'ADMIN_SCHOOLADVANTAGE_DELETE' => '办学优势删除',
  'ADMIN_SCHOOLADVANTAGE_EDITPOST' => '办学优势编辑',
  'ADMIN_SCHOOLADVANTAGE_INDEX' => '办学优势',
  ...
  'PORTAL_ADMINTAG_EDITPOST' => '编辑热门标签保存',
  'PORTAL_ADMINTAG_INDEX' => '新闻推荐版块',
