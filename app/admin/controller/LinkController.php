...
//        var_dump($type);exit;
        ...
        if($type==='class'){
            $links     = $linkModel->where($where)->order('id DESC')->select();
        }else{
    ...
    public function addPost()
    {
        ...
        $this->success("添加成功！", url("link/index",['type'=>$data['type']]));
    }
    ...
    public function editPost()
    {
        ...
        $this->success("保存成功！", url("link/index",['type'=>$data['type']]));
    }
    ...
    public function delete()
    {
        ...
        $this->success("删除成功！", url("link/index",['type'=>$this->request->param('type', '')]));
    }
